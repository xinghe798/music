$(function(){
	/*创建一个数组 存储歌曲信息*/
	var musics=[
		{src:'mp3/梦一场+南山南.mp3',name:'梦一场+南山南',zuozhe:'那英',shichang:'04:33'},
		{src:'mp3/富士山下.mp3',name:'富士山下',zuozhe:'陈奕迅',shichang:'04:17'},
		{src:'mp3/夏洛特烦恼.mp3',name:'夏洛特烦恼',zuozhe:'沈腾',shichang:'03:13'},
		{src:'mp3/同桌的你.mp3',name:'同桌的你',zuozhe:'胡夏',shichang:'04:31'},
    	{src:'mp3/喜欢你.mp3',name:'喜欢你',zuozhe:'邓紫棋',shichang:'04:19'},
		{src:'mp3/那片海.mp3',name:'那片海',zuozhe:'韩红',shichang:'04:28'},
    	{src:'mp3/卡农.mp3',name:'卡农',zuozhe:'卡农',shichang:'00:43'},
		{src:'mp3/会呼吸的痛.mp3',name:'会呼吸的痛',zuozhe:'梁静茹',shichang:'04:33'},
    	{src:'mp3/相见恨晚.mp3',name:'相见恨晚',zuozhe:'彭佳慧',shichang:'04:15'},
  	];
  	/*遍历上面的数组 每遍历到一个数组元素就创建一个ul 并插入页面*/
  	$(musics).each(function(i,v){
    	$('<ul class="sk-le" data-id='+i+'><li class="gqm">'+v.name+'</li><li class="zz">'+v.zuozhe+'</li><li calss="sj">'+v.shichang+'</li><li class="qcfd"></li><div class="yc-k"><li class="dz"></li><li class="fx"></li><li class="sc"></li><li class="delete"></li></div></ul>').appendTo('.sk-lle');
  	})
  	/*声明一个变量存放下标*/
  	var currenIndex;
  	/*当点击歌曲时*/
